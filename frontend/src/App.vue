<template>
  <el-container class="app-container">
    <el-aside width="var(--gw-sidebar-width)" class="sidebar">
      ...
      >
        <el-menu-item index="/">
          <gw-icon icon="game-icons:castle" :size="18" class="menu-icon" />
          <span>首页</span>
        </el-menu-item>
        <el-menu-item index="/blp">
          <gw-icon icon="game-icons:portrait" :size="18" class="menu-icon" />
          <span>BLP 生成</span>
        </el-menu-item>
        <el-menu-item index="/ids">
          <gw-icon icon="game-icons:ancient-keys" :size="18" class="menu-icon" />
          <span>可用 ID</span>
        </el-menu-item>
        <el-sub-menu index="/templates">
          <template #title>
            <gw-icon icon="game-icons:scroll-unfurled" :size="18" class="menu-icon" />
            <span>模板生成</span>
          </template>
        ...
        <el-sub-menu index="/tools">
          <template #title>
            <gw-icon icon="game-icons:anvil" :size="18" class="menu-icon" />
            <span>工具箱</span>
          </template>
